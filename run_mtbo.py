...
for n_offline in variations:
    ...
    # save results
    np.save('data/noffline' + str(n_offline) +'_scores_all_online_mt.npy', scores_all_online_mt)
    np.save('data/noffline' + str(n_offline) +'_scores_all_offline_mt.npy', scores_all_offline_mt)

    np.save('data/noffline' + str(n_offline) +'_pars_all_online_mt.npy', pars_all_online_mt)
    np.save('data/noffline' + str(n_offline) +'_pars_all_offline_mt.npy', pars_all_offline_mt)
