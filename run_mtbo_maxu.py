...
from bo_code.MTBO_maxU import generate_initial_data_mtgp, MTBO_round
...
for n_offline in variations:
    ...
    # save results
    np.save('data/maxu_noffline' + str(n_offline) +'_scores_all_online_mt.npy', scores_all_online_mt)
    np.save('data/maxu_noffline' + str(n_offline) +'_scores_all_offline_mt.npy', scores_all_offline_mt)

    np.save('data/maxu_noffline' + str(n_offline) +'_pars_all_online_mt.npy', pars_all_online_mt)
    np.save('data/maxu_noffline' + str(n_offline) +'_pars_all_offline_mt.npy', pars_all_offline_mt)
